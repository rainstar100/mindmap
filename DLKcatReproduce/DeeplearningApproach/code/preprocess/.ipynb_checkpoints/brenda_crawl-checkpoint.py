from brenda_decorator import timetry
import requests
@timetry
def crawl(params = {'ecno': '1.1.1.102',}):
    headers = {
    ...
    print(params)
    return requests.get('https://www.brenda-enzymes.org/enzyme.php', params=params, headers=headers)