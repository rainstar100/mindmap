...
# query = {'format':'tsv', 'fields[]':fields}

fields=['Buffer', 'Cofactor', 'ECNumber', 'EntryID', 'Organism','Product', 'PubMedID', 'SabioCompoundID', 'SabioReactionID', 'UniprotID', 'Parameter','ReactomeReactionID','Substrate', 'Temperature', 'UniprotID']
# make POST request
query = {'format':'tsv', 'fields[]':fields}
